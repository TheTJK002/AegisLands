...
public class CABlockEntity {
    ...
    public static final RegistryObject<BlockEntityType<ClaimAnchorBlockEntity>> CLAIM_ANCHOR_BE = BLOCK_ENTITIES.register("claim_anchor", () -> BlockEntityType.Builder.of(ClaimAnchorBlockEntity::new, CABlocks.AEGIS_ANCHOR.get()).build(null));
