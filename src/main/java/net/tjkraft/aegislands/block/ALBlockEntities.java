...
public class ALBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<AegisAnchorBlockEntity>> AEGIS_ANCHOR_BE = BLOCK_ENTITY.register("aegis_anchor_be", () -> BlockEntityType.Builder.of(AegisAnchorBlockEntity::new, ALBlocks.AEGIS_ANCHOR.get()).build(null));
